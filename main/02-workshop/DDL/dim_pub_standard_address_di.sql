...
--创建日期:2023-06-07
--********************************************************************--
DROP TABLE IF EXISTS dim_pub_standard_address_di;
CREATE TABLE IF NOT EXISTS dim_pub_standard_address_di (
...
STORED AS parquet
LOCATION 'boschfs://boschfs/warehouse/dim/dim_pub_standard_address_di';
