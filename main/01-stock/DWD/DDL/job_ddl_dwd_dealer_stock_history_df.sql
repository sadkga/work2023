...
--********************************************************************--
-- drop table if exists dwd_dealer_stock_history_df;
create table if not exists dwd_dealer_stock_history_df(
...
partitioned by(ds string comment '时间分区') stored as parquet location 'boschfs://boschfs/warehouse/dwd_dealer_stock_history_df';