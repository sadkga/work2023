...
--********************************************************************--
DROP TABLE IF EXISTS stg_fepaa_currency_lc_di;
CREATE TABLE IF NOT EXISTS stg_fepaa_currency_lc_di(
...
PARTITIONED by(pday STRING COMMENT '时间分区') STORED AS parquet LOCATION 'boschfs://boschfs/warehouse/stg/stg_fepaa_currency_lc_di';