...
"""
 ...
 -- @ LastTime     : 2023-12-10 00:30:15
 -- @ Location     : \\work2023\\main\\03-CDP_push\\push.py
...
class TOBLOB():
    def __init__(self, blob_name, table_name):
         ...
         * @ message : 
         * @ param2   [type] self: 
         * @ param2   [type] blob_name: 
         * @ param2   [type] table_name: 
         * @ return   [type]
        """
        self.blob_name = blob_name
        self.table_name = table_name

    def get_blob_clib(self, strblob_name, f):
        """ 
         * @ message : 获取blob客户端，上传数据
         * @ param2   [type] self: 
         * @ param2   [type] blob_name: blob名字
         * @ param2   [type] f: 上传数据体
         * @ return   [type]
        """
        """获取blob客户端,上传数据"""
